...
public class DeleteFactura extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Ingrese el código del cliente:");
        ...
        jLabel3.setText("Ingrese el numero de contacto:");

        jLabel5.setText("Ingrese el código del cliente:");
        ...
        jLabel6.setText("Desea imprimir:");
    ...
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField1ActionPerformed
        ...
        this.jTextField2.setText(factura.getNombre());
        this.jTextField3.setText(factura.getDireccion());
        this.jTextField5.setText(String.valueOf(factura.getCliente().getCodigo()));
